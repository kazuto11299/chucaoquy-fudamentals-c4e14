...
from random import *
import random
content = '''<p style="text-align: center;">Cộng ho&agrave; X&atilde; hội Chủ nghĩa Việt Nam</p>
...
msg = Message("Xin nghỉ", to = 'c4e14.labs.huynq@gmail.com', html = content.replace("{{REASON}}", n))
gmail.send(msg)
